...
export const presentations: DefaultItem[] = [
	{
		title: "T-REX PDR",
		date: {month: 7, day: 16, year: 2020},
		description: "Presented T-REX rover prototype to engineers from NASA's Jet Propulsion Laboratory in a" +
			"preliminary design review to a group experts in tethered robotics."
	},
	{
		title: "NASA BIG Idea 2020",
