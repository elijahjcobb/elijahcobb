...
const SHIPS: Ship[] = [
  {
    name: "chess",
    year: 2023,
    description: "A chess simulator built with Next.js + AssemblyScript.",
    githubSlug: "elijahjcobb/chess",
    url: "https://chess.elijahcobb.app/",
    wip: false,
  },
  {
    name: "game-of-life",
    year: 2022,
    description: "Conway's game of life made with Next.js + React.js.",
    githubSlug: "elijahjcobb/game-of-life",
    url: "https://game-of-life.elijahcobb.app/",
    wip: false,
  },
  {
    name: "tiny-roads",
